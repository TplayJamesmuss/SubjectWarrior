...
int main(void) {
    ...
    for (int i = 0; i < TOTAL_FRAMES; i++) {
        sprintf_s(filename, sizeof(filename), "knight%d.png", i + 1);
    ...
    title_logo_bitmap = al_load_bitmap("title_logo.png");
    ...
    menu_background_bitmap = al_load_bitmap("menu_background.png");
    ...
    game_background_bitmap = al_load_bitmap("phase.png");
    ...
    ground_bitmap = al_load_bitmap("ground.png");
    if (!ground_bitmap) {
